...
namespace WindowsFormsApp1
{
    public partial class frmNhanVien : Form
    {
        ...
        private void label1_Click(object sender, EventArgs e)
        {
            ...
            txtMaNhanVien.Text = dgvNhanVien.CurrentRow.Cells["MaChatLieu"].Value.ToString();
            txtTenNhanVien.Text = dgvNhanVien.CurrentRow.Cells["TenChatLieu"].Value.ToString();
            btnSua.Enabled = true;
            btnXoa.Enabled = true;
        ...
        {
            string sql;
            sql = "SELECT MaNhanVien,TenNhanVien,GioiTinh,DiaChi,DienThoai,NgaySinh FROm BangNhanVien";
        ...
        private void btnLuu_Click_1(object sender, EventArgs e)
        {
            ...
            if (chkGioiTinh.Checked == true)
                ...
                gt = "Nữ";
            sql = "SELECT MaNhanVien FROM BangNhanVien WHERE MaNhanVien=N'" + txtMaNhanVien.Text.Trim() + "'";
            ...
            sql = "INSERT INTO BangNhanVien(MaNhanVien,TenNhanVien,GioiTinh, DiaChi,DienThoai, NgaySinh) " +
                  "VALUES (N'" + txtMaNhanVien.Text.Trim() + "', N'" + txtTenNhanVien.Text.Trim() + "', N'" + gt + "', " +
                  "N'" + txtDiaChi.Text.Trim() + "', '" + mtbDienThoai.Text + "', '" + mskNgaySinh.Text + "')";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            if (chkGioiTinh.Checked == true)
                ...
                gt = "Nữ";
            sql = "UPDATE BangNhanVien SET  TenNhanVien=N'" + txtTenNhanVien.Text.Trim().ToString() +
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "DELETE BangNhanVien WHERE MaNhanVien=N'" + txtMaNhanVien.Text + "'";
                Functions.RunSQL(sql);
                LoadDataGridView();
                ResetValues();
            }
